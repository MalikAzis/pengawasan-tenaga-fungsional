...
<div class="row pt-2 pb-2">
  <div class="col-sm-12">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Detail IPKPS</li>
    </ol>
  </div>
</div>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <span><i class="fa fa-ribbon"></i> Detail IPKPS</span>
...
@endphp
                          <tr>
                            ...
                            <td></td>
                            <td>
                              <a href=""><button class="btn btn-outline-primary waves-effect pull-right waves-dark m-1">
                              <i class="fa fa-eye"></i>
