...
<div class="row">
  <div class="col-12 col-lg-12 col-xl-12">
    <div class="card">
      ...
      <div class="card-body">
        <canvas id="dash2-chart-5" height="100"></canvas>
        <div class="row">
          <div class="col-12">
...
<div class="row">
  <div class="col-12 col-lg-6 col-xl-6">
    <div class="card">
      ...
      <div class="card-body">
        <canvas id="dash2-chart-6"></canvas>
      </div>
    </div>
  </div>
  <div class="col-12 col-lg-6 col-xl-6">
    <div class="card">
      ...
      <div class="card-body">
        <canvas id="dash2-chart-7"></canvas>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card">
      ...
      <div class="table-responsive">
        <table class="table align-items-center table-flush">
          ...
          <tr>
            <td>
              <img alt="Image placeholder" src="https://via.placeholder.com/1000x903" class="product-img" alt="product img">
            </td>
            <td>Headphone GL</td>
            <td>$1,840 USD</td>
            <td>
...
<div class="row">
  ...
  <div class="col-12 col-lg-6 col-xl-6">
      ...
      <div class="table-responsive">
        <table class="table mb-0">
          ...
          <tr>
            ...
            <td>google.com</td>
            <td>45 <span class="ml-3" id="dash2-chart-8"></span></td>
          </tr>
          <tr>
            <td><i class="fa fa-facebook-square text-facebook"></i> Facebook</td>
            <td>facebook.com</td>
            <td>56 <span class="ml-3" id="dash2-chart-9"></span></td>
          </tr>
          <tr>
            <td><i class="fa fa-twitter text-twitter"></i> Twitter</td>
            <td>twitter.com</td>
            <td>42 <span class="ml-3" id="dash2-chart-10"></span></td>
          </tr>
          <tr>
            <td><i class="fa fa-linkedin-square text-linkedin"></i> Linkedin</td>
            <td>linkedin.com</td>
            <td>52 <span class="ml-3" id="dash2-chart-11"></span></td>
          </tr>
          <tr>
            <td><i class="fa fa-behance text-behance"></i> Behance</td>
            <td>behance.com</td>
            <td>62 <span class="ml-3" id="dash2-chart-12"></span></td>
          </tr>
          <tr>
            <td><i class="fa fa-dribbble text-dribble"></i> Dribble</td>
            <td>dribble.com</td>
            <td>72 <span class="ml-3" id="dash2-chart-13"></span></td>
          </tr>
          <tr>
            <td><i class="fa fa-github text-github"></i> Github</td>
            <td>github.com</td>
            <td>33 <span class="ml-3" id="dash2-chart-14"></span></td>
          </tr>
        </table>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="media">
          <div class="align-self-center"><span id="dash2-chart-15"></span></div>
...
<div class="card-group">
  <div class="card border-right">
    ...
    <div class="card-body">
      <canvas id="dash2-chart-16" height="180"></canvas>
    </div>
    <ul class="list-group list-group-flush list shadow-none">
      <li class="list-group-item d-flex justify-content-between align-items-center">Samsung <span class="badge bg-purple text-white badge-pill shadow">50</span></li>
      <li class="list-group-item d-flex justify-content-between align-items-center">Nokia <span class="badge bg-danger
               text-white badge-pill shadow">50</span></li>
      <li class="list-group-item d-flex justify-content-between align-items-center">Apple <span class="badge bg-info text-white badge-pill">50</span></li>
    </ul>
  </div>
  <div class="card border-right">
    <div class="card-header">
    ...
    <div class="card-body">
      <canvas id="dash2-chart-17" height="180"></canvas>
    </div>
    <ul class="list-group list-group-flush list shadow-none">
      <li class="list-group-item d-flex justify-content-between align-items-center">Gross Profit <span class="badge bg-success text-white badge-pill shadow">05</span></li>
      <li class="list-group-item d-flex justify-content-between align-items-center">Revenue <span class="badge bg-primary
               text-white badge-pill shadow">08</span></li>
      <li class="list-group-item d-flex justify-content-between align-items-center">Expense <span class="badge bg-danger text-white badge-pill shadow">07</span></li>
    </ul>
  </div>
  <div class="card">
    <div class="card-header">
    ...
    <div class="card-body">
      <canvas id="dash2-chart-18" height="180"></canvas>
    </div>
    <ul class="list-group list-group-flush list shadow-none">
      <li class="list-group-item d-flex justify-content-between align-items-center">Jeans <span class="badge bg-danger text-white badge-pill shadow">25</span></li>
      <li class="list-group-item d-flex justify-content-between align-items-center">T-Shirts <span class="badge bg-warning text-white badge-pill shadow">25</span></li>
      <li class="list-group-item d-flex justify-content-between align-items-center">Shoes <span class="badge bg-dark text-white badge-pill shadow">25</span></li>
    </ul>
  </div>
</div>
